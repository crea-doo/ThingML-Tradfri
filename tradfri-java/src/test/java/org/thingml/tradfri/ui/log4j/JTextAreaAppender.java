package org.thingml.tradfri.ui.log4j;
...
public class JTextAreaAppender extends AbstractAppender {
	...
	private static Logger log = LogManager.getLogger(JTextAreaAppender.class);
	...
	@PluginFactory
	public static JTextAreaAppender createAppender(@PluginAttribute("name") String name, @PluginAttribute("maxLines") int maxLines, @PluginAttribute("ignoreExceptions") boolean ignoreExceptions, @PluginElement("Layout") Layout<?> layout, @PluginElement("Filters") Filter filter) {
	...
	// Add the target JTextArea to be populated and updated by the logging
	// information.
